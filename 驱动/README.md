...
|CPUFriend.kext|1.2.8|修复CPU睿频-非必要|new~!|
|HibernationFixup.kext|1.5.0|修复睡眠唤醒-非必要|new~!|
...
|BlueToolFixup2.6.4.kext|2.6.4|Monterey蓝牙修复||
|BlueToolFixup2.6.8.kext|2.6.8|Sonoma蓝牙修复|new~!|
